...
execute as @a if score @s nseekGamerunning matches 1 if score @s nseekDeathcount matches 1 run team join spectators @s

# Clears the inventory of players so they cant get stuff
execute as @a if score @s nseekGamerunning matches 1 run clear @a

# Other stuff
execute as @a if score @s nseekGamerunning matches 0 run team join spectators @s