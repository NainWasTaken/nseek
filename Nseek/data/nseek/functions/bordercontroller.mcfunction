...
execute if score @s nseekRandomisebordercentre matches 1 run execute at @e[type=armor_stand,tag=random_pillar] run spreadplayers ~ ~ 0 100 false @a[team=hiders]
